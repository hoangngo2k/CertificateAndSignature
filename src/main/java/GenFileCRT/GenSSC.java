...
//        genSSC.getCertFromCERTFile();
    ...
    public Certificate getCertFromCERTFile() {
        try {
            FileInputStream fis = new FileInputStream("p12cert/keystore.crt");
    ...
    public void convertCERTToP12 () {
        ...
        try {
            ...
            FileOutputStream fos = new FileOutputStream("p12cert/keystoreConvertFromCERT.p12");
...
//        Generate Certificate Sign Request File
        ...
        FileOutputStream fos = new FileOutputStream("p12cert/keystore.p12");
        keyStore.store(fos, "123456".toCharArray());
        fos.close();

//        Generate Certificate File
        File file = new File("p12cert/keystore.crt");
    ...
    public PKCS10 genCSR() {
        ...
        try {
            ...
            pkcs10.print(ps);
            FileOutputStream fos = new FileOutputStream("p12cert/keystore.csr");
